                ...
                `}>
                    ...
                    <div className="relative font-bold">
                        ...
                        <button type="button" className="
                            w-30pxr h-25pxr absolute top-0 right-0 pt-10pxr pb-15pxr text-[#999999] font-light text-32pxr leading-[0] box-content hidden
                            laptop:block" onClick={()=>{setIsHelp(false)}}>x</button>
                    </div>
                    <div className="text-14pxr pt-20pxr border-t-[1px] border-t-solid border-t-[#979797]">
                        ...
                        <p className="pt-5pxr">1. 커스텀하고 싶은 수만큼 <span
                            className="px-5pxr py-3pxr text-white text-13pxr rounded-3pxr bg-gray-700">추가</span> 버튼 클릭
                            (최대 6칸)</p>
                        ...
                        <p className="pt-5pxr">3. <span
                            className="px-5pxr py-3pxr text-white text-13pxr rounded-3pxr bg-gray-700">다음</span> 버튼을
                            클릭하여 커스텀하는 화면으로 이동
                        </p>
                        <span className="block pt-30pxr text-13pxr">* 추가 버튼 클릭하는 화면부터, <b className="text-red-500">즉 완전 처음부터 다시 하고 싶을 경우</b> 아래 <span
                            className="px-5pxr py-3pxr text-white text-12pxr rounded-3pxr bg-gray-700">초기화</span> 버튼 클릭</span>
                        <span className="block text-13pxr">* 4칸 콤카를 커스텀하고 싶은데 6칸으로 설정했을 경우 5번 칸 클릭 후 <span
                            className="px-5pxr py-3pxr text-white text-12pxr rounded-3pxr bg-gray-700">아래 선택한 칸부터 끝까지 제거</span> 버튼 클릭</span>
                    </div>
                </div>
                <div>
                    {/* 콤보 카드 입력 창 */}
                    ...
                    <div
                        ...
                        <form action="/custom">
                            <div
                                className="w-351pxr pt-140pxr px-25pxr pb-44pxr m-auto bg-no-repeat bg-[length:100%_100%] bg-[url('/public/images/common/combocard_bg.jpg')]">
                                <div>
                                    {
                                                        ...
                                                        className="h-58pxr relative flex flex-row-reverse items-center -mt-20pxr">
                                                        {
                                                            !element.isShow ?
                                                                <button
                                                                    ...
                                                                    onMouseEnter={() => addMouseEnter(index)}
                                                                    onMouseLeave={() => addMouseLeave()}
                                                                    onClick={() => addClickShow(index)}>추가
                                                                </button>
                                                                : null
                                                        }
                                                        {
                            ...
                            <div className="flex justify-center gap-5pxr mt-10pxr">
                                <button type="submit"
                                        ...
                                        onClick={(event) => {
                                            ...
                                            const pageNextDataPush = () => {
                                                countShow.map((element) => dispatch(pageNextInitData({
                                                    skill: element.skill,
                            ...
                            return (
                                <div className="flex cursor-pointer" onClick={() => {
                                    ...
                                    <div
                                        ...
                                        <img
                                            src={`${process.env.PUBLIC_URL}/images/common/skill/${element.englishName}.jpg`}
                                            alt={element.name}
